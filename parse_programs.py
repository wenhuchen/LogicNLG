...
if __name__ == '__main__':
    ...
    parser.add_argument("--gen_prog_bootstrap", default=False, action="store_true", help="whether to generate programs")
    parser.add_argument("--gen_prog", default=False, action="store_true", help="whether to generate programs")
    parser.add_argument("--gen_pattern", default=False, action="store_true", help="whether to generate programs") 
    parser.add_argument("--rank_prog_bert", default=False, action="store_true", help="whether to rank programs")
    parser.add_argument("--rank_prog", default=False, action="store_true", help="whether to rank programs")
    parser.add_argument("--evaluate", default=False, action="store_true", help="whether to rank programs")
    parser.add_argument("--compute_score", default=False, action="store_true", help="whether to rank programs")
    parser.add_argument("--parse", default=False, action="store_true", help="whether to parse the output file")
    parser.add_argument("--score_file", default=None, type=str, help="whether to rank programs")
    parser.add_argument("--batch_size", default=64, type=int, help="batch size for training")
    parser.add_argument("--model_type", default='bert', type=str, help="batch size for training")
    parser.add_argument("--model_name_or_path", default='bert-base-uncased', type=str, help="batch size for training")    
    parser.add_argument("--num_workers", default=16, type=int, help="batch size for training")
    parser.add_argument("--dim", default=256, type=int, help="batch size for training")
    parser.add_argument("--head", default=4, type=int, help="batch size for training")
    parser.add_argument("--layer", default=3, type=int, help="batch size for training")
    parser.add_argument("--load_from", default=None, type=str, help="batch size for training")
    parser.add_argument("--vocab", default='data/ranker_vocab.json', type=str, help="batch size for training")
    parser.add_argument("--csv_path", default='data/all_csv', type=str, help="batch size for training")
    parser.add_argument("--cache_dir", default='/tmp/', type=str, help="batch size for training")
